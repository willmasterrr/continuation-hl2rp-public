...
local Continuation_superTesters = {
	["STEAM_0:1:105767785"] = true, -- The_Mario
	["STEAM_0:1:629138811"] = true, -- vbov
	["STEAM_0:0:217827373"] = true, -- pablo james
	["STEAM_0:0:623102552"] = true, -- nic
}
...
impulse.Badges = {
	...
	supertester = {Material("icon16/bug.png"), "This player made contributions to impulse.", function(ply) return (superTesters[ply:SteamID()] or false) end},
	cont_supertester = {Material("icon16/bug.png"), "This player made large contributions to the testing of continuation.", function(ply) return (Continuation_superTesters[ply:SteamID()] or false) end},
	...
	continuation_badge = {Material("impulse/icons/server-logo-128.png"), "This player.. i mean.. SPECIAL PLAYER.. is the owner of Continuation.", function(ply) return not ply:IsIncognito() and (ply:SteamID() == "STEAM_0:0:193471001") or (ply:SteamID() == "STEAM_0:1:196695929") end},
