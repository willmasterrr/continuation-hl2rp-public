...
function PANEL:SetItem(panel)
	...
	self.ItemColour = panel.Item.Colour or color_white
	...
	self.ItemIsRestricted = panel.Item.IsRestricted or false
	...
	if self.ItemIsEquipped then
		extraMarkup = extraMarkup.."<colour=0, 200, 0, 255>This item is equippable</colour>\n"
	end
...
local darkCol = Color(54, 54, 54, 180)
