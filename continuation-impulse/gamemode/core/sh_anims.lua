...
impulse.Anim.vort = {
	...
	pistol = {
		[ACT_MP_STAND_IDLE] = {"actionidle", "actionidle"},
		[ACT_MP_CROUCH_IDLE] = {"crouchidle", "crouchidle"},
		[ACT_MP_WALK] = {ACT_WALK, ACT_WALK},
		[ACT_MP_CROUCHWALK] = {ACT_WALK, ACT_WALK},
		[ACT_MP_RUN] = {ACT_RUN, ACT_RUN}
...
impulse.Anim.council = {
	normal = {
		[ACT_MP_STAND_IDLE] = {"busyidle2", "busyidle2"},
		[ACT_MP_CROUCH_IDLE] = {ACT_COVER_PISTOL_LOW, ACT_COVER_PISTOL_LOW},
		[ACT_MP_WALK] = {ACT_WALK, ACT_WALK},
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, ACT_WALK_CROUCH},
		[ACT_MP_RUN] = {ACT_RUN, ACT_RUN}
...
impulse.Anim.SetModelClass("models/dpfilms/metropolice/rtb_police.mdl", "council")
...
impulse.Anim.SetModelClass("models/player/animated_combine_soldier.mdl", "overwatch")
...
-- 	return seqIdeal, ply.impulseForceSeq or oldSeqOverride or ply.CalcSeqOverride or -1
-- end

-- OLD CalcMainActivity, BOTTOM IS FIXED ONE
