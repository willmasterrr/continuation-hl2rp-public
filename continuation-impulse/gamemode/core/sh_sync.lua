...
SYNC_GROUP_COL = impulse.Sync.RegisterVar(SYNC_STRING)

SYNC_DOOR_APARTMENT = impulse.Sync.RegisterVar(SYNC_STRING)
SYNC_DOOR_APARTMENT_NUM = impulse.Sync.RegisterVar(SYNC_STRING)
SYNC_DOOR_APARTMENT_OWNED = impulse.Sync.RegisterVar(SYNC_STRING)
...
-- CONTINUATION
SYNC_CMBPOINTS = impulse.Sync.RegisterVar(SYNC_HUGEINT)
