...
impulse.lib.includeDir("continuation-impulse/gamemode/libs")
-- Load config
...
-- Load core
impulse.lib.includeDir("continuation-impulse/gamemode/core")
-- Load core vgui elements
impulse.lib.includeDir("continuation-impulse/gamemode/core/vgui")
-- Load hooks
impulse.lib.includeDir("continuation-impulse/gamemode/core/hooks")
...
function impulse.reloadPlugins()
	local files, folders = file.Find("continuation-impulse/plugins/*", "LUA")

    for v, plugin in ipairs(folders) do
        MsgC( Color( 83, 143, 239 ), "[impulse] Loading plugin '"..plugin.."'\n" )
        impulse.Schema.LoadPlugin("continuation-impulse/plugins/"..plugin, plugin)
    end
end
