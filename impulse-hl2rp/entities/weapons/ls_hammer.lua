...
SWEP.WorldModel = Model("models/weapons/w_hamabar.mdl")
SWEP.ViewModel = Model("models/weapons/w_hamabar.mdl")
--models/props_c17/tools_wrench01a.mdl
SWEP.ViewModelOffset = Vector(-7.635, 17.557, 4.519)
SWEP.ViewModelOffsetAng = Angle(0, -40, -90)
