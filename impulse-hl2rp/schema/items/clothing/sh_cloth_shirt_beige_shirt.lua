...
ITEM.UniqueID = "cos_shirt_beige_shirt"
ITEM.Name = "Beige Jacket"
ITEM.Desc =  "A weathered beige button-up jacket with a high collar, visible dirt stains, and a slightly padded design."
...
ITEM.Bodygroup = 3 --  Bodygroup Slot
