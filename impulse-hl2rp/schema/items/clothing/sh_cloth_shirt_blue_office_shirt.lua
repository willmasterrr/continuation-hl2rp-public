...
ITEM.UniqueID = "cos_shirt_blue_office_shirt"
ITEM.Name = "Blue Office Shirt"
ITEM.Desc =  "A button-up blue office shirt with a collared neckline and long sleeves, made from lightweight fabric."
...
ITEM.Bodygroup = 10 --  Bodygroup Slot
