...
ITEM.UniqueID = "cos_pants_black_pants"
ITEM.Name = "Black Pants"
ITEM.Desc =  "A pair of black straight-leg pants made from durable fabric, featuring belt loops, a button closure, and side pockets."
