...
ITEM.UniqueID = "cos_pants_brown_pants"
ITEM.Name = "Brown Pants"
ITEM.Desc =  "A pair of brown straight-leg pants made from durable fabric, featuring belt loops, a button closure, and side pockets."
...
ITEM.Bodygroup = 5 --  Bodygroup Slot
