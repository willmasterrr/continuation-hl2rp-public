...
ITEM.UniqueID = "cos_shirt_orange_uu_shirt"
ITEM.Name = "Orange UU Shirt"
ITEM.Desc =  "A white button-up office shirt with a collared neckline, featuring the UU logo on the chest and a orange logo on one sleeve."
...
ITEM.Bodygroup = 12 --  Bodygroup Slot
