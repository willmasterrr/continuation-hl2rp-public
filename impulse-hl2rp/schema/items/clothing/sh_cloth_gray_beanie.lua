...
ITEM.UniqueID = "cos_gray_beanie"
ITEM.Name = "Gray Beanie"
ITEM.Desc =  "A knitted gray beanie made from soft, breathable fabric with a snug fit and a folded cuff for added warmth."
