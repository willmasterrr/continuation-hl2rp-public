...
ITEM.UniqueID = "cos_shirt_blue_uu_shirt"
ITEM.Name = "Blue UU Shirt"
ITEM.Desc =  "A white button-up office shirt with a collared neckline, featuring the UU logo on the chest and a blue logo on one sleeve."
...
ITEM.Bodygroup = 14 --  Bodygroup Slot
