...
function ITEM:OnUse(ply, door)
	...
	ply:Say("/me Consumes a vortessence nugget.")
	ply:Notify("The effects of the vortessence have taken affect... It will last approximately " .. string.NiceTime(impulse.Config.VortessenceTime) .. ".")
	ply:ScreenFade(SCREENFADE.IN, Color(190, 82, 240), 2, 1)
	ply:Give("ls_vort")
