...
// Use this 4 connected doors
impulse.Config.AptsDoors = {
	{name = "101-1", doors = {951, 950}},
	{name = "104-1", doors = {948, 949}},
}
...
impulse.Config.LoadScript = function()
	...
	-- Not used as of now, Re-enable if vending machines are added correctly
...
--Version 1.2
--Script by a member of the industrial17 team that wishes to remain anonymous
--This script is for public use, if you modify it for your own purposes please give the team credit.
