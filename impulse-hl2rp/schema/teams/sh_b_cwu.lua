TEAM_CWU = impulse.Teams.Define({
	...
	classes = {
		...
		{
			name = "Workshift Leader",
			description = "wip",
			limit = 1,
			bodygroups = {{1, 12}, {2, 1}},
			xp = 0,
			whitelistUID = "CWU_WorkShiftLeaderRole",
			whitelistLevel = 1,
            -- whitelistFailMessage = "You need a whitelist for it."
		},
		{
