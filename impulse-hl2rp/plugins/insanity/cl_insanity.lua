...
function PLUGIN:Think()
	...
	if level == 5 and math.random(1,3) == 2 then
		local msg = table.Random(fakeTalking)
		chat.AddText(team.GetColor(TEAM_CITIZEN),table.Random(CRAZYNAME_CACHED),Color(255, 255, 100)," says: ",msg)
	end
